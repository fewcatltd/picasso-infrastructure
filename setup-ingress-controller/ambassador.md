...
3. Then, create the [echo](/setup-ingress-controller/assets/manifests/ambassador/echo_deployment.yaml) and [quote](/setup-ingress-controller/assets/manifests/ambassador/quote_deployment.yaml) deployments:
...
Next, create a `Mapping` for [echo](/setup-ingress-controller/assets/manifests/ambassador/echo_mapping.yaml) and [quote](/setup-ingress-controller/assets/manifests/ambassador/quote_mapping.yaml) backend applications:
